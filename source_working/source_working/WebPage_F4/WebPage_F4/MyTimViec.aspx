<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="MyTimViec.aspx.cs" Inherits="WebPage_F4.MyTimViec" %>
...
<div id="menu">
	<div id="mainmenu">
    	<ul>
	        ...
	        <li><a href="MyTimViec.aspx" class="current">My Tìm Việc</a></li>
