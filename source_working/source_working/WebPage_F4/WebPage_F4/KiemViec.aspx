<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="KiemViec.aspx.cs" Inherits="WebPage_F4.KiemViec" %>
...
<div id="menu">
	<div id="mainmenu">
    	<ul>
			...
			<li><a href="KiemViec.aspx" class="current">Kiếm Việc</a></li>
