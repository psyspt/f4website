    ...
    public class NhaTuyenDungDAO
    {
        ...
        public int GetIDNhaTuyenDung(string Email)
        {
            ...
            try
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("sp_GetIDNHATUYENDUNG", connect);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    SqlParameter Email_param = cmd.Parameters.Add("@Email", System.Data.SqlDbType.NVarChar);
